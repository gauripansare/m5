gRecordData = {
    ...
    Questions: [
                    {
                        QuestionId: "1",
                        QuestionText: "How do you open a new Finder window in the Mac OS Sierra operating system?",
                        Options: [
                                     {
                                         "OptionId": "1",
                    ...
                    {
                        QuestionId: "3",
                        QuestionText: "How do you change the desktop background in the Mac OS Sierra operating system?",
                        Options: [
                                     {
                                         "OptionId": "1",
